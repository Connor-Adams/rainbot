...
router.get('/summary', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
...
router.get('/commands', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
...
router.get('/sounds', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/users', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/user-sounds', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
...
router.get('/guilds', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/time', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
...
router.get('/queue', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/history', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
...
router.get('/errors', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
...
router.get('/performance', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
...
router.get('/sessions', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/retention', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
...
router.get('/search', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/user-sessions', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/user-tracks', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/user/:userId', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
...
router.get('/engagement', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/interactions', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/playback-states', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
...
router.get('/web-analytics', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/guild-events', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
  const limit = parseLimit(req.query.limit as string);
...
router.get('/api-latency', statsRateLimiter, requireAuth, asyncHandler(async (req, res) => {
  const filters = parseFilters(req.query);
...
router.get('/check-tables', statsRateLimiter, requireAuth, asyncHandler(async (_req, res) => {
  const tables = [
    'command_stats',
    'sound_stats',
    'queue_operations',
