...
export function EditModal({
  ...
  // The Dialog itself closes on Escape (bound at the document level). When the
  // emoji picker is open we want Escape to close just the picker first, so we
  // intercept it here and stop it from reaching the Dialog's listener.
  ...
  return (
    <Dialog open onClose={onCancel} title="Customize Sound" size="lg">
