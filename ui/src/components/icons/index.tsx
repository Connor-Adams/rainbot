...
export function SkipBackIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M18 4v16l-10-8 10-8zM6 4h2v16H6V4z" />
    </svg>
  );
}
...
export function SkipPreviousIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SkipNextIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/** Sidebar / bottom nav — dashboard sections */
export function NavPlayerIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function NavSoundboardIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function NavRecordingsIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function NavStatsIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function NavStatusIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function NavAdminIcon({ size = 20, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
