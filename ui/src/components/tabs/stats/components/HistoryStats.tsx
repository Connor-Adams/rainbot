    ...
    <StatsSection title="Listening History">
      <div className="history-filters flex gap-3 mb-6">
        <input
          ...
          className="px-4 py-2 bg-surface-input border border-border rounded-lg text-text-primary text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <table className="stats-table w-full">
            ...
            <tbody>
              {history.map((entry: ListeningHistoryEntry, index: number) => {
                ...
                return (
                  <tr key={index} className="hover:bg-surface-elevated/50 transition-colors">
