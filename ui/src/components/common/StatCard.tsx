...
export default function StatCard({ value, label, icon, className = '' }: StatCardProps) {
  return (
    <div
      className={`stat-card bg-surface border border-border rounded-xl p-6 text-center transition-all hover:border-border-hover hover:-translate-y-0.5 hover:shadow-lg ${className}`}
    >
