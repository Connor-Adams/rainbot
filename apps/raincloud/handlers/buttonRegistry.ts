...
import { registerButtonHandler } from './buttonHandler.ts';
import {
  handlePauseButton,
  handleSkipButton,
  handleStopButton,
  handleQueueButton,
} from './musicButtonHandlers.ts';
import { handleQueuePaginationButton } from './paginationButtonHandlers.ts';
import { handleConfirmButton, handleCancelButton } from './confirmButtonHandlers.ts';
