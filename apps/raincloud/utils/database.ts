...
type QueryResultType = pg.QueryResult;
 ...
 */
export function initDatabase(): PoolType | null {
 ...
 */
export async function query(text: string, params?: unknown[]): Promise<QueryResultType | null> {
  if (!pool) {
